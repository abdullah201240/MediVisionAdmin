  ...
  const quickActions = [
    {
      ...
      description: 'View, add, and edit medicine database',
      icon: Pill,
    ...
    },
    {
      ...
      description: 'Find medicines using image recognition',
      icon: Camera,
      color: 'bg-purple-100 text-purple-600',
      action: () => setImageSearchOpen(true)
    }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {statCards.map((stat, index) => (
          <Card key={index} className="hover:shadow-lg transition-all duration-300 border-0 shadow-sm bg-white/70 backdrop-blur-sm">
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                  ...
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-1">
                    {searchResults.map((medicine) => (
                      <div
                        key={medicine.id}
                        className="bg-white border-2 border-gray-200 rounded-xl p-4 hover:border-blue-500 hover:shadow-xl transition-all cursor-pointer group backdrop-blur-sm"
          ...
          <Card className="bg-white/70 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              {quickActions.map((action, index) => (
                <div 
                  key={index}
                  className="flex items-start gap-4 p-4 rounded-lg bg-gray-50/50 hover:bg-gray-100/50 cursor-pointer transition-all duration-300 border border-gray-200/50 hover:border-gray-300/50 backdrop-blur-sm"
          ...
          <Card className="bg-white/70 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              {systemStatus.map((status, index) => (
                <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-gray-50/50 backdrop-blur-sm">
